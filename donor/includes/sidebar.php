<aside class="bg-gray-800 text-white w-64 min-h-screen flex flex-col">
    <div class="p-6 border-b border-gray-700">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400">Donor Portal</p>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 px-4 py-6">
        <ul class="space-y-2">
            ...
            <li>
                <a href="donation_history.php" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700 transition <?php echo basename($_SERVER['PHP_SELF']) === 'donation_history.php' ? 'bg-gray-700' : ''; ?>">
